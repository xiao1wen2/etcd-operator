...
import (
	...
	etcdv1 "github.com/xiaowen/etcd-operator/pkg/apis/etcd/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &etcdv1.EtcdRestore{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *etcdv1.EtcdRestore) *corev1.Pod {
